...
class Renderer
    ...
    renderTable: ->
        ...
        if do_variants_analysis
            ...
            areatbl = []
            for entry in detail when (entry.type == "Convolution" or entry.type == "Concat" or entry.type == "SoftmaxWithLoss" or entry.type == "SigmoidCrossEntropyLoss" or entry.type == "innerproduct")
